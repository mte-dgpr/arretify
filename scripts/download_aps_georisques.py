...
def process_icpe_data(icpe_data: Dict, code_aiot: str, out_dir: str):
    ...
    for document_data in icpe_documents:
        ...
        try:
            ...
            err_msg = f"Unknown file type '{file_type}', please specify if it should be catched or not"
...
def download_one_icpe(code_aiot: str, out_dir: str):
...
if __name__ == '__main__':
    ...
    parser.add_option("-i", "--icpe-file", default='tmp/20240813_permis_consolidés_état_des_lieux_MAJ_27_aout_2024 annoté.csv')
