...
class TestParseOperations(unittest.TestCase):
    ...
    def test_simple(self):
        assert process_operations(
            ...
            '<span class="dsr-operation" data-direction="rtl" data-has_operand="false" data-keyword="remplacées" data-operand="" data-operation_type="replace" data-references="">sont <b>remplacées</b></span>',
    ...
    def test_has_operand(self):
        assert process_operations(
            ...
            '<span class="dsr-operation" data-direction="rtl" data-has_operand="true" data-keyword="remplacées" data-operand="" data-operation_type="replace" data-references="">sont <b>remplacées</b> comme suit :</span>',
        ]
