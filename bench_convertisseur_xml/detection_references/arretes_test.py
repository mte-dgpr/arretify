...
class TestParseDateFunction(unittest.TestCase):
    ...
    def test_arrete_date1(self):
        ...
        arretes = _parse_arretes(soup, ARRETE_DATE1_RE)
        expected_elements = [
            'Vu l\'',
            '<a class="dsr-arrete" data-authority="ministériel">arrêté ministériel du <time class="dsr-date" datetime="1998-02-02">2 février 1998</time></a>',
            ', ',
        ]
