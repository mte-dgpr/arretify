...
class TestResolveSectionsDocuments(unittest.TestCase):
    def test_unknown_arrete(self):
        assert process_sections_and_documents(
          ...
          '</a>'
            ...
            '<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://arrete___2016-05-23_/article__5__">article 5</a>'
            'de l’'
            '<a class="dsr-document_reference" data-is_resolvable="false" data-uri="dsr://arrete___2016-05-23_">'
            'arrêté du'
            '<time class="dsr-date" datetime="2016-05-23">'
    ...
    def test_code(self):
        assert process_sections_and_documents(
            ...
            '<span class="dsr-sections_and_document_references">'
            '<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://code____Code%20de%20l%27environnement/article__R.181-48__">article R.181-48</a>'
            'et suivants du'
            '<a class="dsr-document_reference" data-is_resolvable="false" data-uri="dsr://code____Code%20de%20l%27environnement">'
            'code de l\'environnement'
            '</a>'
    ...
    def test_too_many_words_connector(self):
        assert process_sections_and_documents(
            ...
            'code de l\'environnement'
            '</a>'
        )[0] == '<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__R.181-48__">article R.181-48</a>'
