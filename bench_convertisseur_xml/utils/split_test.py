...
from .split import (
    split_string, split_string_at_end, split_string_at_beginning, merge_matches_with_siblings, 
    split_match_by_named_groups, MatchNamedGroup, StrOrMatch, merge_strings,
)
...
class TestMergeMatchWithSiblingString(unittest.TestCase):
    ...
    def test_split_with_matches(self):
        ...
        # Act
        result = list(merge_matches_with_siblings(split_string(
            pattern,
            string,
        ), 'following'))
