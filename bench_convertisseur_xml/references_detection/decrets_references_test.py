...
class TestParseDecretsReferences(unittest.TestCase):
    ...
    def test_simple(self):
        assert _parsed_elements('Bla bla décret n°2005-635 du 30 mai 2005 relatif à') == [
            'Bla bla ',
            '<a class="dsr-document_reference" data-is_resolvable="false" data-uri="dsr://decret__2005-635_2005-05-30_">décret n°2005-635 du <time class="dsr-date" datetime="2005-05-30">30 mai 2005</time></a>',
            ' relatif à',
        ]
