...
class TestParseArreteReferences(unittest.TestCase):
    ...
    def test_arrete_date1_end_modifiant(self):
        assert process_children('arrêté ministériel du 23 mai 2016 modifiant relatif aux installations de production de chaleur') == [
...
class TestParseArretePluralReferences(unittest.TestCase):
    ...
    def test_references_multiple(self):
        assert process_children('Les arrêtés préfectoraux n° 5213 du 28 octobre 1988 et n° 1636 du 24/03/95 blabla.') == [
            'Les ', 
...
class TestParseArreteReferencesAll(unittest.TestCase):
    ...
    def test_several_references(self):
        assert process_children('Bla bla arrêté ministériel du 23 mai 2016 relatif aux installations de production de chaleur et arrêté préfectoral n° 1234-567/01.') == [
            'Bla bla ',
