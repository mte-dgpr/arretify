...
class TestHandleArticleRange(unittest.TestCase):
    ...
    def test_article_num(self):
        assert process_children("article 4.1.b") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__4.1.b__">article 4.1.b</a>']
        assert process_children("article 8") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__8__">article 8</a>']
        assert process_children("article 1er") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__1__">article 1er</a>']
        assert process_children("article 111è") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__111__">article 111è</a>']
        assert process_children("article 2ème") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__2__">article 2ème</a>']

    def test_code_article(self):
        assert process_children("article R. 511-9") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__R511-9__">article R. 511-9</a>']
        assert process_children("article D.12") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__D12__">article D.12</a>']
        assert process_children("article L181-3") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__L181-3__">article L181-3</a>']

    def test_ordinal(self):
        assert process_children("article premier") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__1__">article premier</a>']
        assert process_children("article quatrième") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__4__">article quatrième</a>']

    def test_article_num_range(self):
        assert process_children("articles 3 à 11") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__3__11">articles 3 à 11</a>']
        assert process_children("articles 6.18.1 à 6.18.7") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__6.18.1__6.18.7">articles 6.18.1 à 6.18.7</a>']
        assert process_children("articles 6.18.a à 6.18.c") == ['<a class="dsr-section_reference" data-is_resolvable="false" data-uri="dsr://unknown____/article__6.18.a__6.18.c">articles 6.18.a à 6.18.c</a>']
