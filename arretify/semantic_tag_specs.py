...
class PageSeparatorData(SemanticTagData):
    page_index: int
    """
    0-based index of the page after which the separator is located.
    For example, if page_index=3, it means that the separator is located between page 3 and page 4.
    """
