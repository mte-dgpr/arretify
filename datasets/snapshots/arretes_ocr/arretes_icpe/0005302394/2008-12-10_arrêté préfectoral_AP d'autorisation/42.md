...
| :--: | :--: | :--: |
| $\mathrm{pH}, \mathrm{Cr} \mathrm{VI}$ | Quotidienne | Rapides ou normalisées adaptées aux concentrations à mesurer |
| Cr III, $\mathrm{Zn}, \mathrm{Fe}$ | Hebdomadaire | Rapides ou normalisées adaptées aux concentrations à mesurer |
| $\mathrm{pH}, \mathrm{MES}, \mathrm{DCO}$, phosphore total, indice hydrocarbure, Zinc, Fer, chrome III, chrome VI, aluminium, tributylphosphate, azote global. | Trimestrielle | Normalisées par un laboratoire agréé |
