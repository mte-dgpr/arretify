...
| :--: | :--: | :--: | :--: | :--: |
|  |  | $\begin{gathered} \text { (e } 0123 \text { o } \\ \text { (caux résiduaires) } \end{gathered}$ | $\begin{gathered} \text { e } 0121 \text { o } \\ \text { (caux pluviales de voirie) } \end{gathered}$ | $\begin{gathered} \text { e } 0122 \mathrm{o} \\ \text { (caux pluviales de toiture) } \end{gathered}$ |
...
| Dénomination <br> de l'ouvrage | N'BSS | Localisation par <br> rapport aux <br> installations | Aquifère capté | Profondeur atteinte <br> (m) |
| :-- | :--: | :--: | :--: | :--: |
