...
\% Le conditionnement des échantillons devra être réalisé dans des contenants conformes aux méthodes officielles en vigueur, spécifiques aux substances à analyser et/ou à la norme NF EN ISO 5667-38.
\% Le transport des échantillons vers le laboratoire devra être effectué dans une enceinte maintenue à une température égale à $8^{\circ} \mathrm{C} \pm 3^{\circ} \mathrm{C}$, et être accompli dans les 24 heures qui suivent la fin du prélèvement, afin de garantir l'intégrité des échantillons.
