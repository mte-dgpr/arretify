...
Le réseau d'eau d'incendie doit pouvoir assurer en toutes circonstances un débit minimal de $420\mathrm{m}^3/\mathrm{h}$ sur les 8 poteaux en simultané.

Les bâtiments de production et de stockage (hormis le bâtiment 9) sont équipés d'un réseau d'extinction automatique à l'eau, alimenté à partir d'une réserve d'eau de $140\mathrm{m}^3$ équipée de 2 pompes utilisant deux sources d'énergie distinctes.
