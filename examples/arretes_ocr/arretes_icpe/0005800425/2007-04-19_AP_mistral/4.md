...
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 2920 | 2-b | D | Réfrigération ou compression (installations de) fonctionnant à des pressions effectives supérieure à $10^{5} \mathrm{~Pa}$. <br> 2. Dans tous les autres cas : <br> (c)supérieure à 50 kW , mais inférieure ou égale à 500 kW . | Compression : 2 * 65 kW Réfrigération : $70 \div 30 \mathrm{~kW}$ | Puissance totale absorbée | $\begin{aligned} & 50<\mathrm{P} \leq \\ & 500 \mathrm{~kW} \end{aligned}$ | 230 | kW |
| 2925 | $/$ | NC | Accumulateurs (Ateliers de charge) | $/$ | Puissance maximale de courant continu utilisable | $P<50 \mathrm{~kW}$ | 35 | kW |
...
| 1530 | $/$ | NC | Bois, papier, carton ou matériaux combustibles analogues (dépôts de) | $/$ | Quantité de matière susceptible d'être présente | $\begin{gathered} Q<1000 \\ \mathrm{~m}^{2} \end{gathered}$ | 200 | $\mathrm{m}^{3}$ |
