...
- dans les virages de rayon intérieur inférieur à 50 mètres, un rayon intérieur R minimal de 13 mètres est maintenu et une sur-largeur de $\mathrm{S}=15 / \mathrm{R}$ mètres est ajoutée;
- elle résiste à la force portante calculée pour un véhicule de 160 kN avec un maximum de 90 kN par cssieu;
