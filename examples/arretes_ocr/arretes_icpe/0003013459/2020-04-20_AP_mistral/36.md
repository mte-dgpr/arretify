...
$\mathrm{R}=$ [énergie produite/energie primaire]* 100
...
ECSR + Ecombustible(s) (MWh/an) = énergie contenue dans les CSR [ $\Sigma \mathrm{PCl}^{*}$ quantité CSR utilisés] + Energie contenue dans les autres combustibles utilisés [ $\Sigma \mathrm{PCl}^{*}$ quantité autres combustibles utilisés]
