...
| Communes | Parcelies |
| :--: | :--: |
|  | Section AC $n^{\circ} 12$ |
|  | Section AC $n^{\circ} 672$ |
|  | Section AC $n^{\circ} 782$ |
|  | Section AC $n^{\circ} 469$ |
|  | Section AC $n^{\circ} 664$ |
...
La surface occupée par les installations, voies, aires de circulation est égale à $46450 \mathrm{~m}^{2}$.
