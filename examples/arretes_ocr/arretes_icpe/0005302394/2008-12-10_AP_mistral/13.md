...
- Installations de traitement de surfaces ( $n^{\circ}$ de conduit : 1 à 5) avant le 31 décembre 2009
- Installations de cataphorèse ( $n^{\circ}$ de conduit : 6 et 7 ) avant le 31 décembre 2008.
...
| $N^{\circ}$ de conduit | Installations raccordées |
| :--: | :-- |
| 1 | Zingage Lanco 1 |
| 2 | Zingage Lanco 2 |
| 3 | TS époxy entrée |
...
|  | Hauteur <br> en m | Débit nominal en <br> $\mathrm{Nm3} / \mathrm{h}$ | Vitesse mini d'éjection <br> en $\mathrm{m} / \mathrm{s}$ |
| :-- | :--: | :--: | :--: |
| Conduit $\mathrm{N}^{\circ} 1$ | 10 | 16800 | 8 |
| Conduit $\mathrm{N}^{\circ} 2$ | 10.5 | 18800 | 8 |
| Conduit $\mathrm{N}^{\circ} 3$ | 8 | 5500 | 8 |
| Conduit $\mathrm{N}^{\circ} 4$ | 8 | 5500 | 8 |
| Conduit $\mathrm{N}^{\circ} 5$ | 9,5 | 13200 | 8 |
| Conduit $\mathrm{N}^{\circ} 6$ | 6 | 1400 | 5 |
| Conduit $\mathrm{N}^{\circ} 7$ | 6,5 | 600 | 5 |
| Conduit $\mathrm{N}^{\circ} 8$ | 10 | 700 | 5 |
