...
2. Toutes les concentrations mesurées pour la substance sont strictement inférieures à la limite de quantification LQ définie dans le tableau de l'annexe 1 du présent arrêté ( $4^{\text {eme }}$ colonne du tableau);
