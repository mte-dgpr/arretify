...
\% Le transport des échantillons vers le laboratoire devra être effectué dans une enceinte maintenue à une température égale à $5^{\circ} \mathrm{C} \pm 3^{\circ} \mathrm{C}$, et être accompli dans les 24 heures qui suivent la fin du prélèvement, afin de garantir l'intégrité des échantillons.
